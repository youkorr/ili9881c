...
void ILI9881CDisplay::set_rotation(Rotation rotation) {
  this->rotation_ = rotation;
  this->apply_rotation_();
}

void ILI9881CDisplay::apply_rotation_() {
...
int ILI9881CDisplay::get_width_internal() {
  return this->width_;
}

int ILI9881CDisplay::get_height_internal() {
  return this->height_;
}

void ILI9881CDisplay::get_rotated_coordinates_(int x, int y, int &rotated_x, int &rotated_y) {
...
void ILI9881CDisplay::draw_absolute_pixel_internal(int x, int y, Color color) {
...
void ILI9881CDisplay::set_dimensions(uint16_t width, uint16_t height) {
...
// Mise à jour de la méthode setup pour inclure la rotation
void ILI9881CDisplay::setup() {
  ESP_LOGCONFIG(TAG, "Setting up ILI9881C display...");
...
// Ajout dans send_init_commands_ pour configurer la rotation matérielle
void ILI9881CDisplay::send_init_commands_() {
...
void ILI9881CDisplay::set_hardware_rotation_() {
...
// Mise à jour de dump_config pour inclure la rotation
void ILI9881CDisplay::dump_config() {
...
// Mise à jour de get_buffer_length_internal_ pour utiliser les dimensions physiques
size_t ILI9881CDisplay::get_buffer_length_internal_() {
  if (this->pixel_format_ == RGB565) {
